  ...
  return (
    <Container style={{ margin: "100px 0" }}>
      <p>
        ...
        data types. We also provide off-the-shelf data and tailor-made data for
        the success of your AI/ML projects. At Wow AI, we have high-quality QA
        and CQA personnel who maintain strong overall quality control of
        datasets adhering to reliability, performance, and client expectation.
        Many companies have successfully built their AI models with us. So do
        you!
      </p>
      <div style={{ display: "flex", height: "50vh", margin: "100px 0" }}>
      ...
      >
        <p style={description}>
          ...
          instantly while working on projects; consequently we can deliver the
          highest quality AI data
        </p>
        <p style={description}>
          With a crowd of over 100,000+ skilled freelancers locating around the
          global, we can handle any large- scale projects
        </p>
        <p style={description}>
          One of our advantages is competitive pricing. You can save a lot of
          money if you choose us
        </p>
      </div>
    </Container>
  );

...
const Header = () => {
  return (
    <div style={{ backgroundColor: "var(--primary-bg)", paddingBottom: "2vh" }}>
      ...
      <hr
        style={{ color: "var(--primary-text)", height: "2px", marginTop: "0" }}
      />
          ...
          <Navbar.Collapse id="basic-navbar-nav" className="navbar-contai">
            ...
            <NavDropdownStyled title="Services" id="basic-nav-dropdown">
              <ul style={{ marginBottom: "0" }}>
                ...
                <li style={liStyled}>
                  <ItemLink to="/data-collection">Data Collection</ItemLink>
                </li>
                <li style={liStyled}>
                  <ItemLink to="/data-annotation">Data Annotation</ItemLink>
                </li>
              </ul>
            </NavDropdownStyled>
            <LinkStyled to="/off-the-shelf">Off The Shelf data</LinkStyled>
            <LinkStyled to="/resources">Resources</LinkStyled>

...
const Achieverments = () => {
  return (
    <Contain id="achieverments" className="section-scroll">
      <div style={Content}>
        <div>
          ...
          <DescripStyled>
            ...
            <span>
              14 000 audio hours <br /> in 14 languages
            </span>
          </DescripStyled>
        </div>
        <div>
        ...
        <div>
          ...
          <DescripStyled>
            <FontAwesomeIcon icon={faCircleCheck} style={Icon} />
            <span>
              12 000 recording audio <br /> hours in 6 languages
            </span>
          </DescripStyled>
        </div>
      </div>
      ...
      <div style={Content}>
        <div>
          <h2 className="title-description">
            4. Automotive Video <br /> Annotation
          </h2>
          <DescripStyled>
            <FontAwesomeIcon icon={faCircleCheck} style={Icon} />

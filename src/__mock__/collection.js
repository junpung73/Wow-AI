    ...
    boxst: [
      {
        ...
        description:
          "We assist you in collecting various forms of invoices such as online invoices, shopping invoices, cab receipts, hotel bills, and other.",
      },
      {
        ...
        description:
          "We can assist you with gathering all forms of crucial documents, such as a driver's license or a credit card, from various locations.",
      },
    ],
  },
  {
    ...
    boxst: [
      {
        ...
        description:
          "Collect data from individual speakers in the form of prepared, directed, or spontaneous speech. The speaker is chosen based on your.",
      },
      {
        title: "Dialogue Speech Collection",
        description:
          "Collect guided or spontaneous speech datasets/interactions between a Call Center Agent and a Caller or a Caller and a Bot depending.",
      },
    ],
  },
  {
    ...
    boxst: [
      {
        title: "Document Dataset Collection",
        description:
          "We offer image datasets of a variety of papers, such as an invoice, a receipt, a menu, and so on.",
      },
      {

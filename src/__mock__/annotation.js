    ...
    boxst: [
      {
        title: "Tagging",
        description:
          "Optical Character Recognition (OCR) is taking all of the images of texts, regardless of whether they were printed, handwritten or typed into editable text formats.",
      },
      {
    ...
    boxst: [
      {
        title: "Tagging",
        description:
          "Sound labeling involves the separation of all of the needed sounds and labeling them. These could be specific terms or the sound of a specific musical instrument, for example.",
      },
      {
    ...
    boxst: [
      {
        title: "Tagging",
        description:
          "This annotation technique involves projecting a rectangular 2D box over each frame's target object, which assists the system in recognizing the real things.",
      },
      {
        title: "3D Boxes",
        description:
